...
public class DefaultFileImporterTests {
    ...
    public void test() throws NoSuchMethodException, ClassNotFoundException {
        ...
        final DefaultDataFileImporterBase<String, BeanForTest> importer = new TestDataFileImporter();
    ...
    private static final class TestDataFileImporter extends DefaultDataFileImporterBase<String, BeanForTest> {
        @Override
        protected void processOneRow(final String filePath, final DataFileContext dataFileContext,
            ...
            switch (row.getRowNumber()) {
                ...
                case 5:
                    ...
                    break;
                default:
                    Assert.fail("Row number is expected to be 1 - 5: " + row.getRowNumber());
            }
        }
    }
}
